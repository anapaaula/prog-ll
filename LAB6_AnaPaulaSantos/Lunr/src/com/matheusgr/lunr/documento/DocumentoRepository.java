...
public class DocumentoRepository {
	...
	public int totalDocumentos() {
		this.validador.validacao(documentos);
	...
	public Set<Documento> busca() {
		Set<Documento> docs = this.documentos.values().stream().collect(Collectors.toSet());
		this.validador.validacao(docs);
