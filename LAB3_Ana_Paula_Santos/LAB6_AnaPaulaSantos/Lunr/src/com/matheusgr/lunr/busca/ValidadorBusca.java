...
class ValidadorBusca extends ValidadorPadrao {
	...
	public void valida(String nomeDaBusca, Busca busca) {
		Objects.requireNonNull(busca, "Conteúdo não pode ser nulo");
		if (nomeDaBusca == null) {
			throw new NullPointerException("Nome da busca nulo.");
		}
		if(!nomeDaBusca.isBlank()) {
			throw new IllegalArgumentException("Nome da busca vazio.");
			}
		return;
	}
	}
